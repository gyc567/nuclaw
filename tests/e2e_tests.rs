...
mod performance_tests {
    ...
    fn test_onboard_telegram_only() {
        ...
        assert_eq!(
            ...
            Some("987654:XYZ-telegram-token".to_string())
        );
    ...
    fn test_onboard_custom_endpoint_config() {
        ...
        assert_eq!(
            loaded.base_url,
            Some("https://my-custom-llm.com/v1".to_string())
        );
...
"#;
    ...
    fn test_onboard_special_characters_in_token() {
        ...
        assert_eq!(
            loaded.api_key,
            Some("sk-ant-test+special=chars".to_string())
        );
        assert_eq!(
            loaded.telegram_token,
            Some("123456:ABC-DEF_special+chars".to_string())
        );
