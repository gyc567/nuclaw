...
fn test_directory_creation() {
    ...
    assert!(config::groups_dir().exists(), "Groups directory should exist");
}
...
fn test_database_initialization() {
    ...
    assert!(tables.contains(&"chats".to_string()), "chats table should exist");
    assert!(tables.contains(&"messages".to_string()), "messages table should exist");
    assert!(tables.contains(&"scheduled_tasks".to_string()), "scheduled_tasks table should exist");
    assert!(tables.contains(&"task_run_logs".to_string()), "task_run_logs table should exist");
}
